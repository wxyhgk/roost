/* 逐字取自 deepseek-ai/deepseek-harness@0d1f500 packages/client/ui-primitives/src/markdown/MarkdownText.tsx —— MIT，Copyright (c) 2026 DeepSeek。改动见 ../NOTICE.md。 */
/**
...
// ROOST-CHANGE：上游这里是 `import 'katex/dist/katex.min.css'`（静态）。样式表跟着引擎一起
// 按需加载，见 ./katex-lazy.ts 的文件头——留在这里等于把 KaTeX 的一半体积重新钉回静态图。
