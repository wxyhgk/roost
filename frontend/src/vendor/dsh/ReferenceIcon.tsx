/* 逐字取自 deepseek-harness（MIT，`packages/client/ui-primitives/src/ReferenceIcon.tsx`，提交 0d1f500）。
   `user-text.tsx` 的 @ 引用芯片要它画那三个字形；两个图标在我们已搬的 icons/index.tsx 里都有。
   同 file-size.ts：NOTICE.md 的「没搬什么」里列着它，这次被 MessageItem 带了进来。 */
