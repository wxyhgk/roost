/* 逐字取自 deepseek-ai/deepseek-harness@0d1f500 packages/client/ui-primitives/src/TerminalBlock.tsx —— MIT，Copyright (c) 2026 DeepSeek。改动见 ./NOTICE.md。 */
import { useCallback, useMemo, useState } from 'react'
import clsx from 'clsx'
// ROOST-CHANGE：ansi.ts / head-tail-cap.ts 不进 vendor 目录，改指 shared/terminal-text 里
// 已有的那一份（它的颜色映射换成了我们的主题令牌，配套测试在 frontend/tests/ansi.test.ts）。
import { parseAnsiLines, type AnsiLine } from '../../shared/terminal-text/ansi.ts'
import { headTailCap } from '../../shared/terminal-text/head-tail-cap.ts'
