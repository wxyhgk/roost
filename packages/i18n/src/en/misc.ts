    ...
    detail: {
      ...
      send: {
        ...
        queuedReason: {
          ...
          acceptanceUncertainHint: "The previous one was written to the terminal but the CLI has not confirmed it. Check the terminal; this one resumes once that clears.",
