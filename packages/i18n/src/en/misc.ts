...
export const misc = {
  ...
  conversations: {
    ...
    columnEmpty: "Pick a conversation on the left, or start one by talking to an agent in a terminal.",
  ...
  leftRail: {
    ...
    conversationsTitle: "Conversations: catalog · transcript · terminal",
    terminal: "Terminal",
    terminalTitle: "Terminal: workspaces · screen · files",
