export const serverMonitor = {
  ...
  portsScopePublic: "公开",
  portsScopeLocal: "仅本机",
  portsScopeInterface: "指定网卡",
  portsScopeHint: { public: "任何网卡都连得上", local: "只有本机连得上", interface: "绑在某一张网卡上" },
  portsMine: "从 roost 的会话起的",
  portsOthers: "其他进程",
  portsSessionGone: "（会话已不在）",
  portsRenameHint: "双击侧边栏的会话名即可改名",
